...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/portal/css/",
        js: project_folder +"/local/templates/portal/js/",
        img: project_folder +"/local/templates/portal/img/",
        image: project_folder +"/local/templates/portal/image/",
        fonts: project_folder +"/local/templates/portal/fonts/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/portal/scss/style.scss",
        js: source_folder +"/local/templates/portal/js/script.js",
        img: source_folder +"/local/templates/portal/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/portal/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/portal/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/local/templates/portal/scss/**/*.scss",
        js: source_folder +"/local/templates/portal/js/**/*.js",
        img: source_folder +"/local/templates/portal/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/portal/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/local/templates/portal/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/portal/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/portal/img/'))
});
